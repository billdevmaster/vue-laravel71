    ...
    data() {
        return {
            columns: [
                ...
                { title: 'B.Amount', field: 'amount', sortable: true },
                { title: 'TTL For Buy', field: 'total', sortable: true },
                { title: 'B / S Rate', field: 'rate', sortable: true },
                { title: 'S.Amount', field: 'amount', sortable: true },
                { title: 'TTL For Sell', field: 'total', sortable: true },
